...
public class TByteFloatHashMap
  ...
  implements TByteFloatMap, Externalizable
{
  ...
  protected class TKeyView implements TByteSet
  {
    ...
    {
      return new TByteFloatHashMap.TByteFloatKeyHashIterator(TByteFloatHashMap.this, TByteFloatHashMap.this);
    }
  ...
  protected class TValueView implements TFloatCollection
  {
    ...
    {
      return new TByteFloatHashMap.TByteFloatValueHashIterator(TByteFloatHashMap.this, TByteFloatHashMap.this);
    }
  ...
  public String toString()
  {
    ...
    forEachEntry(new TByteFloatProcedure() {
      ...
      public boolean execute(byte key, float value) { if (first) first = false; else {
          buf.append(", ");
        }
        buf.append(key);
        buf.append("=");
