  ...
  implements TDoubleIntMap, Externalizable
{
  ...
  protected class TKeyView implements TDoubleSet
  {
    ...
    {
      return new TDoubleIntHashMap.TDoubleIntKeyHashIterator(TDoubleIntHashMap.this, TDoubleIntHashMap.this);
    }
  ...
  protected class TValueView implements TIntCollection
  {
    ...
    {
      return new TDoubleIntHashMap.TDoubleIntValueHashIterator(TDoubleIntHashMap.this, TDoubleIntHashMap.this);
    }
  ...
  public String toString()
  {
    ...
    forEachEntry(new TDoubleIntProcedure() {
      ...
      public boolean execute(double key, int value) { if (first) first = false; else {
          buf.append(", ");
        }
        buf.append(key);
        buf.append("=");
