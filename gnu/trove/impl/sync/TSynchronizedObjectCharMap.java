  ...
  implements TObjectCharMap<K>, Serializable
{
  ...
  public void putAll(TObjectCharMap<? extends K> map) { synchronized (mutex) { m.putAll(map);
    } }
  ...
  public TObjectCharIterator<K> iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TObjectCharProcedure<? super K> procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TCharFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TObjectCharProcedure<? super K> procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
