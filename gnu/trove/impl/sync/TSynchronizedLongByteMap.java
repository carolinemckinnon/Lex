  ...
  implements TLongByteMap, Serializable
{
  ...
  public TLongByteIterator iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TLongByteProcedure procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TByteFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TLongByteProcedure procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
