  ...
  implements TCharShortMap, Serializable
{
  ...
  public TCharShortIterator iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TCharShortProcedure procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TShortFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TCharShortProcedure procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
