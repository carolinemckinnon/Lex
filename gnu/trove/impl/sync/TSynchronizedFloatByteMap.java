  ...
  implements TFloatByteMap, Serializable
{
  ...
  public TFloatByteIterator iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TFloatByteProcedure procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TByteFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TFloatByteProcedure procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
