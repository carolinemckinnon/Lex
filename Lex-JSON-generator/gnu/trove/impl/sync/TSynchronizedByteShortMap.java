  ...
  implements TByteShortMap, Serializable
{
  ...
  public TByteShortIterator iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TByteShortProcedure procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TShortFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TByteShortProcedure procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
