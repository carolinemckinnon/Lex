  ...
  implements TLongDoubleMap, Serializable
{
  ...
  public TLongDoubleIterator iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TLongDoubleProcedure procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TDoubleFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TLongDoubleProcedure procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
