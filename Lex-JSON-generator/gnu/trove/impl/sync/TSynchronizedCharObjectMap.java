  ...
  implements TCharObjectMap<V>, Serializable
{
  ...
  public void putAll(TCharObjectMap<? extends V> map) { synchronized (mutex) { m.putAll(map);
    } }
  ...
  public TCharObjectIterator<V> iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TCharObjectProcedure<? super V> procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TObjectFunction<V, V> function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TCharObjectProcedure<? super V> procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    }
  }
