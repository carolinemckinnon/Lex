  ...
  implements TLongCharMap, Serializable
{
  ...
  public TLongCharIterator iterator() { return m.iterator(); }
  ...
  public boolean forEachEntry(TLongCharProcedure procedure) { synchronized (mutex) { return m.forEachEntry(procedure);
    } }
  
  public void transformValues(TCharFunction function) { synchronized (mutex) { m.transformValues(function);
    } }
  
  public boolean retainEntries(TLongCharProcedure procedure) { synchronized (mutex) { return m.retainEntries(procedure);
    } }
