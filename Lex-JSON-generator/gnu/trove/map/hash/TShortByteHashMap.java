...
public class TShortByteHashMap
  ...
  implements TShortByteMap, Externalizable
{
  ...
  protected class TKeyView implements TShortSet
  {
    ...
    {
      return new TShortByteHashMap.TShortByteKeyHashIterator(TShortByteHashMap.this, TShortByteHashMap.this);
    }
  ...
  protected class TValueView implements TByteCollection
  {
    ...
    {
      return new TShortByteHashMap.TShortByteValueHashIterator(TShortByteHashMap.this, TShortByteHashMap.this);
    }
  ...
  public String toString()
  {
    ...
    forEachEntry(new TShortByteProcedure() {
      ...
      public boolean execute(short key, byte value) { if (first) first = false; else {
          buf.append(", ");
        }
        buf.append(key);
        buf.append("=");
