  ...
  implements Serializable
{
  ...
  public void addPreference(String relation, SparseDoubleVector vector, double frequency)
  {
  ...
  public void addInversePreference(String relation, SparseDoubleVector vector, double frequency)
  {
    add(relation, new ScaledSparseDoubleVector(vector, frequency), 
  ...
  private void add(String relation, SparseDoubleVector vector, Map<String, SparseDoubleVector> map)
  {
    SparseDoubleVector preference = (SparseDoubleVector)map.get(relation);
    if (preference == null) {
      map.put(relation, 
  ...
  public SparseDoubleVector preference(String relation) {
    return (SparseDoubleVector)selPreferences.get(relation);
  }
  
  public SparseDoubleVector inversePreference(String relation) {
    return (SparseDoubleVector)inverseSelPreferences.get(relation);
  }
}
