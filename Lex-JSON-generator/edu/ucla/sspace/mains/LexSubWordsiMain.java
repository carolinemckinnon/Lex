...
public class LexSubWordsiMain
{
  ...
  public static void main(String[] args)
  {
    ...
    BasisMapping<String, String> basis = 
      (BasisMapping)SerializableUtil.load(new File(args[2]));
    ...
    while (docIter.hasNext()) {
      extractor.processDocument(((Document)docIter.next()).reader(), wordsi);
    }
  }
  ...
  public static class LexSubWordsi implements Wordsi
  {
    ...
    public void handleContextVector(String focus, String secondary, SparseDoubleVector vector)
    {
      ...
      MultiMap<Double, String> topWords = comparator.getMostSimilar(
        bestSense, 10);
      output.printf("%s ::", new Object[] { secondary });
      for (String term : topWords.values())
        output.printf(" %s", new Object[] { term });
      output.println();
    }
