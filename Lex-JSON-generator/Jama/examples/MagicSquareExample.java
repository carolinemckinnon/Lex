  ...
  public static void main(String[] argv)
  {
    ...
    for (int n = 3; n <= 32; n++) {
      ...
      Jama.EigenvalueDecomposition E = 
        new Jama.EigenvalueDecomposition(M.plus(M.transpose()).times(0.5D));
      ...
      double c = M.cond();
      print(c < 1.0D / eps ? fixedWidthDoubletoString(c, 12, 3) : 
        "         Inf");
      
      Jama.LUDecomposition LU = new Jama.LUDecomposition(M);
      Matrix L = LU.getL();
      Matrix U = LU.getU();
      int[] p = LU.getPivot();
      ...
      Jama.QRDecomposition QR = new Jama.QRDecomposition(M);
      Matrix Q = QR.getQ();
      R = QR.getR();
      R = Q.times(R).minus(M);
      res = R.norm1() / (n * eps);
    ...
    double etime = (stop_time.getTime() - start_time.getTime()) / 1000.0D;
    print("\nElapsed Time = " + 
