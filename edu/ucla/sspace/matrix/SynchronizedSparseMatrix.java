...
public class SynchronizedSparseMatrix
  implements SparseMatrix, AtomicMatrix, Serializable
{
  private static final long serialVersionUID = 1L;
  private final SparseMatrix m;
  
  public SynchronizedSparseMatrix(SparseMatrix matrix)
  {
    m = matrix;
  }
  ...
  public synchronized SparseDoubleVector getColumnVector(int column)
  {
  ...
  public synchronized SparseDoubleVector getRowVector(int row)
  {
